...
const StudentForm = ({
  ...
  return (
    <form className="flex flex-col gap-8 bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-neutral-200" onSubmit={onSubmit}>
      ...
      {state.error && (
        <span className="text-error-600 bg-error-50 p-3 rounded-lg border border-error-200">Something went wrong!</span>
      )}
      <button type="submit" className="bg-primary-600 hover:bg-primary-700 text-white p-4 rounded-xl font-medium transition-all duration-200 shadow-md hover:shadow-lg">
