...
export default function Navbar({ onMenuToggle, isSidebarOpen }: NavbarProps) {
  ...
  return (
    <nav className="bg-white border-b border-neutral-100 px-4 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {isSearchOpen && (
              <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-neutral-100 rounded-lg shadow-sm z-50">
                <div className="p-3">
                  <input
                    type="text"
                    placeholder="Search..."
                    className="w-full px-3 py-2 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                    autoFocus
                  />
                </div>
              </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative navbar-dropdown">
            ...
            {isNotificationsOpen && (
              <div className="absolute top-full right-0 mt-2 w-80 bg-white border border-neutral-100 rounded-lg shadow-sm z-50">
                <div className="p-4">
          ...
          <div className="relative navbar-dropdown">
            ...
            {isDropdownOpen && (
              <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-neutral-100 rounded-lg shadow-sm z-50">
                <div className="py-1">
                  <button
